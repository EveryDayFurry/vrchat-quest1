...
2. Search for **"Quest App Version Switcher"** (QAVS, by ComputerElite) and sideload it
...
**Option B — GitHub APK:**
1. Download the latest QAVS APK from [ComputerElite/QuestAppVersionSwitcher releases](https://github.com/ComputerElite/QuestAppVersionSwitcher/releases/latest)
2. Sideload it onto the headset:
   ```bat
   adb install QuestAppVersionSwitcher.apk
   ```
3. Then follow steps 3–6 from Option A
